...
to My Social Media Accounts to Contact with me if you need Developer. `
  ...
  return (
    ...
    <div id='AboutME' className='w-full bg-black pt-60'>
     ...
     <div className='flex gap-10 flex-col items-center md:flex-row P-2 md:p-10'>
        ...
        <div data-aos='flip-up' className='md:w-1/2 w-11/12 p-2 md:p-10 border-orange-600 shadow-orange-600 shadow-lg border-2 rounded-lg '>
